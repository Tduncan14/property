            ...
            <main>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                    ...
                    >
                        ...
                        <p>
                            <FaRulerCombined className="fa-solid  inline-block mr-2 fa-ruler-combined"></FaRulerCombined>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                    ...
                    >
                        {property.amenities.map((amenity, index) => (
                            <li>
                                <FaCheck class="inline-block text-green-600 " />
                                <i key={index} className="fas fa-check text-green-600 mr-2 mt-3"></i> {amenity}
                            </li>
